...
begin
  ...
  begin
    s:=exename;
    MessageBoxW(0, pwidechar(exename+' could not be found. Please disable/uninstall your anti virus and reinstall title_kmlzimukt7 to fix this'),'title_kmlzimukt7 launch error',MB_OK or MB_ICONERROR);
  end;
