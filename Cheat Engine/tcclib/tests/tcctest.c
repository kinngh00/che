...
static void ce_683ub2(char *fn, int line, int num) {
...
#define ce_683ub2(x) ce_683ub2(__FILE__,__LINE__,x)
    ce_683ub2(123);
    WRAP(ce_683ub2(123));
    WRAP(WRAP(ce_683ub2(123)));
...
static int ce_iwvtt2(int x) { return x; }
static void *_csf = ce_iwvtt2;
...
void char_short_test()
{
    ...
    *(int *)&var1 = 0x08090a0b;
    ...
    /* We can't really express GCC behaviour of return type promotion in
       the presence of undefined behaviour (like ce_iwvtt2 is).  */
...
static void ce_gdcjyc(int nargs, int posd,...)
{
    int i;
    double d;
    point pi;
...
void stdarg_test(void)
{
    ...
    stdarg_syntax(1, 17);
    ce_gdcjyc(6,-1,pts[0],pts[1],pts[2],pts[3],pts[4],pts[5]);
    ce_gdcjyc(7,1,pts[0],-1.0,pts[1],pts[2],pts[3],pts[4],pts[5]);
    ce_gdcjyc(7,2,pts[0],pts[1],-1.0,pts[2],pts[3],pts[4],pts[5]);
    ce_gdcjyc(7,3,pts[0],pts[1],pts[2],-1.0,pts[3],pts[4],pts[5]);
    ce_gdcjyc(7,4,pts[0],pts[1],pts[2],pts[3],-1.0,pts[4],pts[5]);
    ce_gdcjyc(7,5,pts[0],pts[1],pts[2],pts[3],pts[4],-1.0,pts[5]);
}
