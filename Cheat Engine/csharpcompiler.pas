...
begin
  ...
  r:=DotNetExecuteClassMethod({$ifdef standalonetest}'D:\git\cheat-engine\title_kmlzimukt7\bin\CSCompiler.dll'{$else}cheatengineDir+'CSCompiler.dll'{$endif},'CSCompiler','Compiler','NewCompiler',inttostr(ptruint(@delegates)));
