...
initialization
  ...
  begin
    ...
    if r.OpenKey('\Software\'+{$ifdef altname}'Runtime Modifier'{$else}'title_kmlzimukt7'{$endif},false) then
    begin
    ...
    begin
      ...
      if r.OpenKey('\Software\'+{$ifdef altname}'Runtime Modifier'{$else}'title_kmlzimukt7'{$endif},true) then
      begin
        //I do have access
