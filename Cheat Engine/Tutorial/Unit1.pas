...
resourcestring
  ...
  rsTutorial1='Welcome to the title_kmlzimukt7 Tutorial (v3.6)'+#13#10+
              ''+#13#10+
              'This tutorial will teach you the basics of cheating in video games. It will also show you foundational aspects of using title_kmlzimukt7 (or CE for short). Follow the steps below to get started.'+#13#10+
              ''+#13#10+
              '1: Open title_kmlzimukt7 if it currently isn''t running.'+#13#10+
              ...
              ''+#13#10+
              'Congratulations! If you did everything correctly, the process window should be gone with title_kmlzimukt7 now attached to the tutorial (you will see the process name towards the top-center of CE).'+#13#10+
              ''+#13#10+
