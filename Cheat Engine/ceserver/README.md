...
in directory of  
cheat-engine/name_m3bddnu589/ceserver/gcc  
...
### Linux
 ...
 - Start title_kmlzimukt7 via Wine, or if you are running Linux on a virtual machine, start title_kmlzimukt7 on the host OS.
